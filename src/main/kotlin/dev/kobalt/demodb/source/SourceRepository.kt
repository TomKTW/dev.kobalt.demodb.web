...
package dev.kobalt.demodb.source
...
object SourceRepository {
    ...
    fun selectList(): List<Triple<String, String, String>> = listOf(
        Triple("dev.kobalt.demodb.jvm", "Backend", "Database server where frontend gets the data from."),
        Triple("dev.kobalt.demodb.web", "Frontend", "Website server where data from backend is displayed.")
    )
